...
- ✅ **Toyota Corolla E170** — verified 2026-04-28 against DE Wikipedia (Toyota Corolla section 34). 3 European engines: 1.33 VVT-i (2013–16), 1.6 Valvematic (2013–19), 1.4 D-4D (2013–16). Created from scratch (Toyota not previously in catalog).
- ✅ **Toyota Corolla E210** — verified 2026-04-28 against DE Wikipedia (Toyota Corolla section 39). 4 engines: 1.2T (2019–20), 1.8 HEV 122 KM (2019–22), 1.8 HEV 140 KM (2022–), 2.0 HEV 196 KM (2022–, medium confidence on year). Created from scratch.
- 🟡 **Toyota Corolla E150** — DE Wikipedia has no structured engine table for this gen; entries compiled from training knowledge, all marked medium confidence. Needs second source before promoting to ✅.

...
@Module({
  ...
  controllers: [AdminSubmissionsController, AdminUsersController, AdminDlqController, AdminStationsController],
  providers: [AdminSubmissionsService, AdminUsersService, AnomalyDetectionService, AdminDlqService, AdminStationsService],
})

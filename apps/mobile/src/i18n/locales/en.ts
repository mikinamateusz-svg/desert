export default {
  ...
  log: {
    ...
    manageVehiclesLink: 'Vehicles',
    manageVehiclesA11y: 'Manage vehicles',
  ...
  history: {
    ...
    vehicleSelectorPlaceholder: 'Pick vehicle',
    vehicleSheetTitle: 'Pick vehicle',
    vehiclePillA11y: 'Vehicle filter. Currently: {{current}}. Tap to change.',
    periodSheetTitle: 'Pick period',
    periodPillA11y: 'Period filter. Currently: {{current}}. Tap to change.',

export default {
  ...
  stationDetail: {
    ...
    notInChainFilter: 'Niezgodna z twoim filtrem sieci',
  },
  // Story 2.19 — chain filter UI (pills + sheet + banner).
  mapFilters: {
    fuelPillPrefix: 'Paliwo',
    fuelPillA11y: 'Wybierz paliwo. Obecnie: {{fuel}}.',
    chainPillInactive: 'Sieci',
    chainPillInactiveA11y: 'Filtruj sieci. Pokaż wszystkie.',
    chainPillActive_one: '{{count}} sieć',
    chainPillActive_few: '{{count}} sieci',
    chainPillActive_many: '{{count}} sieci',
    chainPillActive_other: '{{count}} sieci',
    chainPillActiveA11y_one: '{{count}} sieć wybrana. Stuknij, aby zmienić filtr.',
    chainPillActiveA11y_few: '{{count}} sieci wybrane. Stuknij, aby zmienić filtr.',
    chainPillActiveA11y_many: '{{count}} sieci wybranych. Stuknij, aby zmienić filtr.',
    chainPillActiveA11y_other: '{{count}} sieci wybranych. Stuknij, aby zmienić filtr.',
    banner: {
      body_one: '{{activeCount}} sieć aktywna · {{demotedCount}} innych wyciszonych',
      body_few: '{{activeCount}} sieci aktywne · {{demotedCount}} innych wyciszonych',
      body_many: '{{activeCount}} sieci aktywnych · {{demotedCount}} innych wyciszonych',
      body_other: '{{activeCount}} sieci aktywnych · {{demotedCount}} innych wyciszonych',
      a11y: 'Filtr sieci aktywny: {{activeCount}}. Wyciszonych stacji: {{demotedCount}}. Stuknij, aby zmienić.',
      clear: 'Wyczyść',
    },
  },
  chainFilter: {
    title: 'Twoje sieci',
    subtitle: 'Pokażemy je w pełnych kolorach. Inne stacje pozostaną widoczne, ale wyciszone — żebyś nie przegapił taniej oferty.',
    allChains: 'Wszystkie sieci',
    // PL "Zastosuj" doesn't inflect with count — single key is fine.
    applyButton: 'Zastosuj ({{count}})',
    applyButtonAll: 'Zastosuj',
  },
  chainNames: {
    orlen: 'Orlen',
    bp: 'BP',
  ...
  notifications: {
    ...
    modeTargetPrice: 'Cena docelowa',
    targetPricePln: 'Cena docelowa (PLN/L)',
    targetPricePlaceholder: 'np. 6,50',
    invalidTargetPrice: 'Podaj cenę między 1,00 a 20,00',
    fuelTypes: 'Rodzaje paliwa',
    fuelPb95: 'Pb 95',
    fuelPb98: 'Pb 98',
    fuelOn: 'ON',
    fuelOnPremium: 'ON Premium',
    fuelLpg: 'LPG',
    alertRadius: 'Zasięg alertów',
    alertRadiusShared: 'Zasięg alertów (wspólny z alertami o wzrostach)',
    fuelTypesEmptyHint: 'Wybierz przynajmniej jeden rodzaj paliwa, aby otrzymywać alerty.',
    riseCommunity: 'Potwierdzone wzrosty cen',
    riseCommunityDesc: 'Aktywuje się, gdy wielu kierowców zgłosi wzrost cen na tej samej stacji',
    risePredictive: 'Alerty predykcyjne',
    risePredictiveDesc: 'Aktywuje się, gdy sygnały hurtowe sugerują nadchodzący wzrost cen',
    riseRadiusSharedNote: 'Używa Twojego zasięgu {{km}} km z alertów o spadkach cen.',
  },
  feedback: {

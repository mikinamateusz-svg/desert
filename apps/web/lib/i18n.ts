...
export const translations: Record<Locale, Translations> = {
  pl: {
    ...
    footer: {
      tagline: 'Od kierowców, dla kierowców',
      product: 'Litro',
      company: 'O nas',
      legal: 'Dokumenty',
      about: 'O nas',
    ...
    contact: {
      ...
      successMsg: 'Dziękujemy za kontakt. Odpowiemy najszybciej jak to możliwe.',
      errorMsg: 'Nie udało się wysłać wiadomości. Spróbuj ponownie lub napisz bezpośrednio na e-mail.',
      infoTitle: 'Dane kontaktowe',
      infoEmail: 'kontakt@litro.pl',
      infoResponse: 'Odpowiemy najszybciej jak to możliwe.',
    },
    pricing: {
      title: 'Cennik',
  ...
  en: {
    ...
    footer: {
      tagline: 'By drivers, for drivers',
      product: 'Litro',
      company: 'About us',
      legal: 'Documents',
      about: 'About',
    ...
    contact: {
      ...
      successMsg: 'Thank you for reaching out. We will get back to you as soon as possible.',
      errorMsg: 'Could not send message. Please try again or email us directly.',
      infoTitle: 'Contact details',
      infoEmail: 'contact@litro.pl',
      infoResponse: 'We will get back to you as soon as possible.',
    },
    pricing: {
      title: 'Pricing',
